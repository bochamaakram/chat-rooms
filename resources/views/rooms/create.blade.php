                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('rooms.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}"><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required minlength="2">
